...
vi.mock('../../services/jellyfin/library.service.js', () => ({
  LibraryService: {
    getLibrary: vi.fn(),
...
vi.mock('../../services/jellyfin/items.service.js', () => ({
  ItemsService: {}
}));

vi.mock('../../services/home-categories.service.js', () => ({
  HomeCategoriesService: {}
}));

vi.mock('../../services/home-sections.service.js', () => ({
  HomeSectionsService: {}
}));
