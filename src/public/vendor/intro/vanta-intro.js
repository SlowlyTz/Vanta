...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Na(e,t,n){return new si({name:`SphericalGaussianBlur`,defines:{SAMPLES:va,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},sigma:{value:0},mipInt:{value:0}},vertexShader:Ia(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Pa(){return new si({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Ia(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Fa(){return new si({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ia(),fragmentShader:`
	...
	`}var La=class extends Ot{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new qr(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`,Mc=(e,t,n)=>{let r=e()*2-1,i=Math.sqrt(1-r*r),a=e()*Math.PI*2;t[n]=i*Math.cos(a),t[n+1]=i*Math.sin(a),t[n+2]=r};function Nc(e,t){let{count:n,positions:r,colors:i,groups:a,orders:o,bounds:s}=e,c=[-(s.v.minX+s.v.maxX)/2,-(s.v.minY+s.v.maxY)/2,0],l=new Float32Array(n*3),u=new Float32Array(n*3),d=new Float32Array(n),f=new Float32Array(3);for(let e=0;e<n;e++){let n=r[e*2],i=r[e*2+1];if(l[e*3]=n,l[e*3+1]=i,l[e*3+2]=(t()-.5)*.04,d[e]=t(),Mc(t,f,0),a[e]<.5){let r=.5+t()*1.6;u[e*3]=n+c[0]+f[0]*r,u[e*3+1]=i+c[1]+f[1]*r,u[e*3+2]=f[2]*r}else{let r=.12+t()*.3;u[e*3]=n+f[0]*r,u[e*3+1]=i+f[1]*r,u[e*3+2]=f[2]*r}}let p=new cr;return p.setAttribute(`position`,new qn(l,3)),p.setAttribute(`aStart`,new qn(u,3)),p.setAttribute(`aColor`,new qn(i,3)),p.setAttribute(`aGroup`,new qn(a,1)),p.setAttribute(`aOrder`,new qn(o,1)),p.setAttribute(`aSeed`,new qn(d,1)),p.computeBoundingSphere(),p.boundingSphere.radius=4,{geometry:p,vShift:c}}function Pc({canvas:e,sample:t,width:n,height:r,dpr:i=1,random:a=Math.random}){let o=new Sc({canvas:e,antialias:!1,alpha:!1,powerPreference:`high-performance`});o.setPixelRatio(i),o.setClearColor(0,1);let s=new mn,c=new zi(Ec,1,.01,50),{geometry:l,vShift:u}=Nc(t,a),d=new si({vertexShader:Ac,fragmentShader:jc,uniforms:{uForm:{value:0},uSlide:{value:0},uWrite:{value:0},uTime:{value:0},uSize:{value:1},uIntensity:{value:1},uVShift:{value:u}},blending:2,depthWrite:!1,depthTest:!1,transparent:!0});s.add(new Gr(l,d));let f=Math.tan(Ec/2*Math.PI/180),p=t.bounds.logo.maxX-t.bounds.logo.minX,m=t.bounds.logo.maxY-t.bounds.logo.minY,h=(t.bounds.word.minX+t.bounds.word.maxX)/2,g=1,_=(e,a)=>{n=e,r=a,o.setSize(e,a,!1),c.aspect=e/a,c.updateProjectionMatrix(),g=Math.max(p/(2*f*c.aspect*Dc),m/(2*f*Oc)),d.uniforms.uSize.value=a*i*t.spacing*2/(2*f)};return _(n,r),{render:e=>{let t=Tc(e),n=d.uniforms;n.uForm.value=t.form,n.uSlide.value=t.slide,n.uWrite.value=t.write,n.uTime.value=e,n.uIntensity.value=kc*(1-t.fade*.6);let r=t.zoom*t.zoom*t.zoom;return c.position.set(h*.5*r,0,g*(1-r*.94)),c.lookAt(c.position.x,0,0),o.render(s,c),t},resize:_,dispose:()=>{l.dispose(),d.dispose(),o.dispose(),o.forceContextLoss?.()},camera:c}}var Fc=1086,Ic=()=>window.matchMedia?.(`(pointer: coarse)`).matches||(navigator.hardwareConcurrency||8)<=4,Lc=e=>new Promise((t,n)=>{let r=new Image;r.onload=()=>t(r),r.onerror=()=>n(Error(`intro logo failed to load: ${e}`)),r.src=e});function Rc(e,t){let n=Math.round(e.naturalHeight*(t/e.naturalWidth)),r=document.createElement(`canvas`);r.width=t,r.height=n;let i=r.getContext(`2d`,{willReadFrequently:!0});return i.drawImage(e,0,0,t,n),i.getImageData(0,0,t,n)}async function zc(e,{logo:t=`/assets/logo2.png`}={}){let n=e.querySelector(`canvas`)||e.appendChild(document.createElement(`canvas`)),i=Ic(),a=Pc({canvas:n,sample:r(Rc(await Lc(t),Fc),{count:i?16e3:38e3}),width:window.innerWidth,height:window.innerHeight,dpr:Math.min(window.devicePixelRatio||1,i?1.5:2)}),o=()=>a.resize(window.innerWidth,window.innerHeight);window.addEventListener(`resize`,o);try{await new Promise(t=>{let n=0,r=i=>{n||=i;let o=(i-n)/1e3,s=a.render(Math.min(o,4));e.style.opacity=String(1-s.fade),s.done?t():requestAnimationFrame(r)};requestAnimationFrame(r)})}finally{window.removeEventListener(`resize`,o),a.dispose()}}export{zc as playIntro};