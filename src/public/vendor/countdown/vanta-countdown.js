...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ba(e,t,n){return new mi({name:`SphericalGaussianBlur`,defines:{SAMPLES:Ta,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},sigma:{value:0},mipInt:{value:0}},vertexShader:Ua(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Va(){return new mi({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Ua(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ha(){return new mi({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ua(),fragmentShader:`
	...
	`}var Wa=class extends Ft{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new ei(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`,jc=40,Mc=.42,Nc=.86,Pc=.62,Fc=900,Ic=.55,Lc={blending:5,blendSrc:201,blendDst:201,blendSrcAlpha:201,blendDstAlpha:201,premultipliedAlpha:!0},Rc=`
  uniform float uFrom;
  uniform float uTo;
...
`,Bc=(e,t)=>{let n=e()*2-1,r=Math.sqrt(1-n*n),i=e()*Math.PI*2;return t[0]=r*Math.cos(i),t[1]=r*Math.sin(i),t[2]=n,t};function Vc(e,t){let n=e[0].positions.length/2,r=new hr,i=new Float32Array(3),a=new Float32Array(n*3),o=new Float32Array(n);e.forEach((e,i)=>{let a=new Float32Array(n*3);for(let r=0;r<n;r++)a[r*3]=e.positions[r*2],a[r*3+1]=e.positions[r*2+1],a[r*3+2]=(t()-.5)*.03;r.setAttribute(`aT${i}`,new er(a,3))});for(let e=0;e<n;e++){o[e]=t(),Bc(t,i);let n=.9+t()*1.8;a[e*3]=i[0]*n,a[e*3+1]=i[1]*n,a[e*3+2]=i[2]*n}return r.setAttribute(`position`,r.getAttribute(`aT0`)),r.setAttribute(`aStart`,new er(a,3)),r.setAttribute(`aSeed`,new er(o,1)),r.computeBoundingSphere(),r.boundingSphere.radius=4,r}function Hc(e){let t=new hr,n=new Float32Array(Fc),r=new Float32Array(Fc),i=new Float32Array(Fc*3);for(let t=0;t<Fc;t++)n[t]=(t+e()*.5)/Fc,r[t]=e();return t.setAttribute(`position`,new er(i,3)),t.setAttribute(`aAngle`,new er(n,1)),t.setAttribute(`aSeed`,new er(r,1)),t.computeBoundingSphere(),t.boundingSphere.radius=2,t}function Uc({canvas:e,digits:t,width:n,height:r,dpr:i=1,random:a=Math.random}){let o=new kc({canvas:e,antialias:!1,alpha:!0,powerPreference:`high-performance`});o.setPixelRatio(i),o.setClearColor(0,0);let s=new xn,c=new Ki(jc,1,.01,50),l=new mi({vertexShader:Rc,fragmentShader:Ac,uniforms:{uFrom:{value:0},uTo:{value:0},uMorph:{value:1},uGather:{value:0},uLoosen:{value:0},uPulse:{value:0},uTime:{value:0},uSize:{value:1},uIntensity:{value:Ic}},...Lc,depthWrite:!1,depthTest:!1,transparent:!0}),u=new mi({vertexShader:zc,fragmentShader:Ac,uniforms:{uRing:{value:1},uGather:{value:0},uTime:{value:0},uSize:{value:1},uRadius:{value:Pc*t.height},uIntensity:{value:Ic}},...Lc,depthWrite:!1,depthTest:!1,transparent:!0}),d=Vc(t.targets,a),f=Hc(a);s.add(new Qr(d,l)),s.add(new Qr(f,u));let p=Math.tan(jc/2*Math.PI/180),m=Pc*t.height*2.2,h=1,g=(e,n)=>{o.setSize(e,n,!1),c.aspect=e/n,c.updateProjectionMatrix(),h=Math.max(t.height/(2*p*Mc),m/(2*p*c.aspect*Nc));let r=n*i/(2*p);l.uniforms.uSize.value=r*t.spacing*2.2,u.uniforms.uSize.value=r*.018*t.height};return g(n,r),{render:(e,t)=>{let n=l.uniforms;n.uFrom.value=e.from,n.uTo.value=e.to,n.uMorph.value=e.morph,n.uGather.value=e.gather,n.uLoosen.value=e.loosen,n.uPulse.value=e.pulse,n.uTime.value=t,n.uIntensity.value=Ic*(1-e.fade*.5);let r=u.uniforms;r.uRing.value=e.ring,r.uGather.value=e.gather*(1-e.dive),r.uTime.value=t;let i=e.dive*e.dive*e.dive;c.position.set(0,0,h*(1-i*.96)),c.lookAt(0,0,0),o.render(s,c)},resize:g,dispose:()=>{d.dispose(),f.dispose(),l.dispose(),u.dispose(),o.dispose(),o.forceContextLoss?.()},camera:c}}var Wc=.4,Gc=.3,Kc=.85,qc=[4.55,5],Jc=[4.6,5],Yc=e=>Math.min(1,Math.max(0,e)),Xc=([e,t],n)=>Yc((n-e)/(t-e)),Zc=e=>e*e*(3-2*e);function Qc(e,t,n=5e3){return n/1e3-(e-t)/1e3}function $c(e,t=5e3){let n=t/1e3,r=Math.round(n),i=r-1,a=Math.min(n,Math.max(-.4,e)),o=Math.min(i,Math.max(0,Math.floor(a))),s=a<0?0:Math.min(1,a-o),c=Zc(Yc((a+Wc)/Wc)),l=o===0?1:Yc(s/Gc),u=o<i?Zc(Yc((s-Kc)/(1-Kc))):0,d=o>0?1-Zc(l):0;return{digit:r-o,from:Math.max(0,o-1),to:o,gather:c,morph:l,loosen:Math.max(u,d),ring:a<0?1:1-s,pulse:Math.sin(Math.max(0,a)*Math.PI*2)*.5+.5,dive:Xc(qc,a),fade:Xc(Jc,a),done:e>=n}}async function el({container:n,fadeTarget:r=n,startsAtServerTimeMs:i,durationMs:a=5e3,now:o}){let s=e();await c();let l=u({count:s?5e3:12e3}),d=document.createElement(`canvas`);d.className=`watch-party-countdown-canvas`,n.appendChild(d);let f=()=>({width:n.clientWidth||window.innerWidth,height:n.clientHeight||window.innerHeight}),p=f(),m=Uc({canvas:d,digits:l,width:p.width,height:p.height,dpr:t(s)}),h=()=>{let e=f();m.resize(e.width,e.height)};window.addEventListener(`resize`,h);let g=null,_=!1,v,y=new Promise(e=>{v=e}),b=performance.now(),x=()=>{if(_)return;let e=$c(Qc(i,o(),a),a);if(m.render(e,(performance.now()-b)/1e3),r.style.opacity=String(1-e.fade),e.done){v();return}g=requestAnimationFrame(x)};return g=requestAnimationFrame(x),{done:y,destroy(){_||(_=!0,g!==null&&cancelAnimationFrame(g),window.removeEventListener(`resize`,h),m.dispose(),d.remove(),r.style.opacity=``,v())}}}export{$c as countdownAt,el as mountCountdown,Qc as secondsIntoCountdown};